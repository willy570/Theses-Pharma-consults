            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="university" class="col-md-4 col-form-label text-md-right">{{ __('Université') }}</label>
                            ...
                            <label for="level" class="col-md-2 col-form-label text-md-right">{{ __('Niveau') }}</label>
                            <div class="col-md-3">
